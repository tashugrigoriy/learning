...
# Функция шифрует английский текст со сдвигом влево,
# и ДЕШИФРИРУЕТ АНГЛИЙСКИЙ текст, зашифрованный со сдвигом ВПРАВО.

def decrypt_english_text_right(step):
    ...
    for char in text:
        ...
        elif char == char.lower() and ord(char.lower()) - step < 97:
            res += chr(ord(char.lower()) - step + 26)
        elif char == char.upper() and ord(char.upper()) - step < 65:
...
decrypt_english_text_right(text)
